...
* [Niklas von Hertzen](https://github.com/niklasvh "Niklas von Hertzen's page") for the [html2canvas library](https://github.com/niklasvh/html2canvas "html2canvas.js source code").
